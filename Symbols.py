HiraganaDict = dict(a="あ", i="い", u="う", e="え", o="お", ka="か", ki="き", ku="く", ke="け", ko="こ", sa="さ", shi="し", su="す",
                    se="せ", so="そ", ta="と", chi="ち", tsu="つ", te="て", to="と", na="な", ni="に", nu="ぬ", ne="ね", no="の",
                    ha="は", hi="ひ", fu="ふ", he="へ", ho="ほ", ma="ま", mi="み", mu="む", me="め", mo="も", ya="や", yu="ゆ",
                    yo="よ", ra="ら", ri="り", ru="る", re="れ", ro="ろ", wa="わ", wo="を", n="ん")

KatakanaDict = dict(a="ア", i="イ", u="ウ", e="エ", o="オ", ka="カ", ki="キ", ku="ク", ke="ケ", ko="コ", sa="サ", shi="シ", su="ス",
                    se="セ", so="ソ", ta="タ", chi="チ", tsu="ツ", te="テ", to="ト", na="ナ", ni="ニ", nu="ヌ", ne="ネ", no="ノ",
